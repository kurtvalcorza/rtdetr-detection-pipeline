"""Static release-asset validation for the RT-DETR object-detection DIMER pipeline.
...
WORKSHOP_NOTEBOOK_NAME = "DIMER_MultiModel_Closed_Set_Object_Detection_Workshop.ipynb"
